    ...
    <div className="min-h-screen relative overflow-hidden  ">
      ...
      <section className="relative pb-20 pt-30 px-4 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-slate-950 dark:via-slate-900 dark:to-indigo-950 overflow-hidden">
               <div className="absolute inset-0">
                  <Image fill alt="referenceImage" className="object-cover" src="/apply-banner2.jpg" />
                  {/* Dark overlay */}
              ...
              <div className="relative z-10 max-w-7xl mx-auto text-center">
                ...
                <p className="text-xl md:text-2xl text-gray-200 dark:text-gray-300 mb-12 max-w-4xl mx-auto">
                  We’re thrilled you’re interested in joining us! Fill out the form below to share your details and start your journey.
                </p>
              </div>
            </section>
          ...
          <div className="glass-card p-8 rounded-3xl shadow-lg border border-white/20 bg-white/20 backdrop-blur-md">
            {submitted ? (
              <div className="text-center py-12">
                ...
                <p className="text-gray-600 mb-6">Thank you for applying. Our team will review your submission and reach out soon.</p>
                <Link href="/careers">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        className={`pl-10 glass-card border-white/20 bg-transparent ${errors.firstName ? "border-red-500" : ""}`}
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        onChange={handleInputChange}
                        className={`pl-10 glass-card border-white/20 bg-transparent ${errors.lastName ? "border-red-500" : ""}`}
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      onChange={handleInputChange}
                      className={`pl-10 glass-card border-white/20 bg-transparent ${errors.email ? "border-red-500" : ""}`}
                ...
                <div>
                  ...
                  <div
                    className={`relative border-2 border-dashed rounded-lg p-6 text-center ${errors.resume ? "border-red-500" : "border-gray-300"} hover:border-indigo-500 transition-colors`}
                    onDrop={handleFileDrop}
                    onDragOver={(e) => e.preventDefault()}
                  >
                    <Upload className="mx-auto w-8 h-8 text-gray-800 mb-2" />
                    <p className="text-sm text-gray-600 mb-2">
                      {formData.resume ? formData.resume.name : "Drag and drop your resume or click to upload"}
                    </p>
                    <Input
                      id="resume"
                      name="resume"
                  ...
                  {errors.resume && <p className="text-red-500 text-sm mt-1 animate-pulse">{errors.resume}</p>}
                  <p className="text-sm text-gray-800 mt-1">Accepted formats: PDF, DOC, DOCX (max 5MB)</p>
                </div>
                ...
                <div className="flex justify-end gap-4">
                  <Link href="/careers">
                    <Button variant="outline" className="glass-card border-white/20 bg-transparent text-gray-900 hover:bg-indigo-100 rounded-full">
                      Cancel
                    </Button>
                  </Link>
                  <Button type="submit" className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white rounded-full">
